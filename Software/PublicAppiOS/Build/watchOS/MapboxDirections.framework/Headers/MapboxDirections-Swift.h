...
@property (nonatomic, copy) NSURL * _Nonnull apiEndpoint;
...
+ (NSError * _Nonnull)informativeErrorWithDescribing:(NSDictionary<NSString *, id> * _Nonnull)json response:(NSURLResponse * _Nullable)response underlyingError:(NSError * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end


@interface NSHTTPURLResponse (SWIFT_EXTENSION(MapboxDirections))
@property (nonatomic, readonly, copy) NSDate * _Nullable rateLimitResetTime;
@end
...
- (nonnull instancetype)initWithRouteOptions:(MBRouteOptions * _Nonnull)routeOptions legs:(NSArray<MBRouteLeg *> * _Nonnull)legs distance:(CLLocationDistance)distance expectedTravelTime:(NSTimeInterval)expectedTravelTime coordinates:(NSArray<NSValue *> * _Nullable)coordinates OBJC_DESIGNATED_INITIALIZER;
...
- (nonnull instancetype)initWithSteps:(NSArray<MBRouteStep *> * _Nonnull)steps json:(NSDictionary<NSString *, id> * _Nonnull)json source:(MBWaypoint * _Nonnull)source destination:(MBWaypoint * _Nonnull)destination profileIdentifier:(MBDirectionsProfileIdentifier _Nonnull)profileIdentifier OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC16MapboxDirections10RouteLegV4")
@interface RouteLegV4 : MBRouteLeg
- (nonnull instancetype)initWithJson:(NSDictionary<NSString *, id> * _Nonnull)json source:(MBWaypoint * _Nonnull)source destination:(MBWaypoint * _Nonnull)destination profileIdentifier:(MBDirectionsProfileIdentifier _Nonnull)profileIdentifier;
- (nonnull instancetype)initWithSteps:(NSArray<MBRouteStep *> * _Nonnull)steps json:(NSDictionary<NSString *, id> * _Nonnull)json source:(MBWaypoint * _Nonnull)source destination:(MBWaypoint * _Nonnull)destination profileIdentifier:(MBDirectionsProfileIdentifier _Nonnull)profileIdentifier OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)decoder OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nonnull queries;
...
SWIFT_CLASS("_TtC16MapboxDirections11RouteStepV4")
@interface RouteStepV4 : MBRouteStep
- (nonnull instancetype)initWithJson:(NSDictionary<NSString *, id> * _Nonnull)json;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)decoder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC16MapboxDirections7RouteV4")
@interface RouteV4 : MBRoute
- (nonnull instancetype)initWithJson:(NSDictionary<NSString *, id> * _Nonnull)json waypoints:(NSArray<MBWaypoint *> * _Nonnull)waypoints routeOptions:(MBRouteOptions * _Nonnull)routeOptions;
- (nonnull instancetype)initWithRouteOptions:(MBRouteOptions * _Nonnull)routeOptions legs:(NSArray<MBRouteLeg *> * _Nonnull)legs distance:(CLLocationDistance)distance expectedTravelTime:(NSTimeInterval)expectedTravelTime coordinates:(NSArray<NSValue *> * _Nullable)coordinates OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)decoder OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic, readonly, copy) NSString * _Nonnull headingDescription;
...
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
- (id _Nonnull)debugQuickLookObject SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
/// \param json A point feature in GeoJSON format.
///
- (nullable instancetype)initWithGeoJSON:(NSDictionary<NSString *, id> * _Nonnull)json;
@end
